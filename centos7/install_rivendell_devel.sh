...
# Install Packages
#
yum -y install git gcc-c++ automake autoconf libtool qt3-devel qt3-devel libcurl-devel cdparanoia-devel hpklinux-devel alsa-lib-devel jack-audio-connection-kit-devel libsamplerate-devel libsndfile-devel id3lib-devel libvorbis-devel flac-devel pam-devel soundtouch-devel twolame-devel libmad-devel rpm-build createrepo fop docbook5-style-xsl libxslt kernel-devel rpm-sign man-pages openssl-devel

#
# Configure Environment
#
cp /usr/share/rivendell-install/docbook5.sh /etc/profile.d/
